...
export const metadata: Metadata = {
  ...
  description:
    'Understand the structure of nsCore documentation, including command types, usage syntax, permissions, and examples.',
  keywords: [
    'nsCore docs',
  ...
  openGraph: {
    title: 'Documentation Overview - nsCore',
    description:
      'Learn how to read nsCore command documentation, including command types, usage, permissions, and examples.',
    type: 'article',
  },
  twitter: {
    card: 'summary',
