    ...
    <main className="mx-auto max-w-6xl px-6 py-12 space-y-24">
      ...
      <section className="text-center space-y-6">
        ...
        <p className="mx-auto max-w-2xl text-muted-foreground text-lg">
          nsCore is a powerful and informative Discord bot built with
          TypeScript, JavaScript, and discord.js — designed to elevate your
          server experience.
        </p>
      ...
      <section className="text-center space-y-4">
        ...
        <p className="text-muted-foreground max-w-xl mx-auto">
          If you’re confused about commands or need assistance, explore the
          documentation or join our Discord server for support.
        </p>

        <Button asChild variant="outline">
          <Link href="https://discord.gg/your-server">
            Join Support Server
          </Link>
        </Button>
      </section>
