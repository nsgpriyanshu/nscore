...
<Callout>ns.weather</Callout>

Displays weather information for a specified location.

**Usage**: `weather <location>`

This command fetches and displays current weather details for the specified location.

**Parameters**:

- `<location>`: The location for which you want to fetch weather information.
